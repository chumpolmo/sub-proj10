    ...
    <a href="#" class="w3-bar-item w3-button w3-padding"><i class="fa fa-shopping-cart fa-fw"></i> ข้อมูลผลผลิต</a>
    <a href="#" class="w3-bar-item w3-button w3-padding"><i class="fa fa-bullhorn fa-fw"></i> ประกาศจ้างงาน</a>
    <a href="#" class="w3-bar-item w3-button w3-padding"><i class="fa fa-users fa-fw"></i> การจ้างงาน</a>
