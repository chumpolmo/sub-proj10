<?php include 'libs/config.inc.php'; ?>
<!DOCTYPE html>
<html>
<head>
<title><?=_TITLE?></title>
...
<div class="w3-top">
  <div class="w3-bar w3-large w3-amber">
      <a href="#" class="w3-bar-item w3-button w3-block">หน้าแรก</a>
      <a href="#contact" class="w3-bar-item w3-button w3-block">เกี่ยวกับโครงการ</a>
      <a href="#plans" class="w3-bar-item w3-button w3-block">ฝากประวัติ</a>
      <a href="#about" class="w3-bar-item w3-button w3-block">สมัครงาน</a>
      <a href="#contact" class="w3-bar-item w3-button w3-block">ภาพรวมสถิติข้อมูล</a>
      <a href="#contact" class="w3-bar-item w3-button w3-block">ติดต่อเรา</a>
      <a href="#contact" class="w3-bar-item w3-button w3-block w3-right">เข้าสู่ระบบ</a>
    </div>
  </div>
</div>
