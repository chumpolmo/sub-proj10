...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-check-square-o"></i> สมัครงาน</b></h5>
  </header>
  ...
  <form>
    ...
    <div class="w3-bar">
      ...
      <button type="button" class="w3-bar-item w3-button w3-blue" onclick="getData(12, 1, 0, document.getElementById('keyword').value)"><i class="fa fa-search"></i> ค้นหา</button>
    </div>
    </div>
  </form>
  <div id="outresume" class="w3-container">
