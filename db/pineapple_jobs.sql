...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 17, 2023 at 01:44 AM
...
INSERT INTO `product` (`Pro_ID`, `Pro_Title`, `Pro_Description`, `Pro_Photo`, `Pro_Quantity`, `Pro_PricePU`, `Pro_Month`, `Pro_Year`, `Pro_Unit`, `Pro_Added`, `Pro_Updated`, `Farm_ID`) VALUES
(1, 'สับปะรดอบแห้ง', 'สับปะรดอบแห้ง ไม่มีน้ำตาล​ กินเจ ทานได้ คลีนๆ เนื้อล้วน หวานธรรมชาติ', 'prod_figs/prod_1.png', 100, 80, 2, 2023, 'แพ็ค', '2023-02-15 08:35:01', '2023-02-15 08:35:01', 1);
...
INSERT INTO `user` (`User_ID`, `User_Email`, `User_Password`, `User_Type`, `User_Active`, `User_Added`, `User_Updated`) VALUES
(1, 'admin@mail.com', 'Admin@1234', 1, 1, '2023-02-03 10:44:57', '2023-02-03 10:44:57'),
(2, 'ajkhaeg@mail.com', 'Ajkhaeg@1234', 2, 1, '2023-02-03 10:45:47', '2023-02-03 10:45:47'),
(3, 'mrjob@mail.com', 'Mrjob@1234', 3, 1, '2023-02-03 10:46:27', '2023-02-03 10:46:27');
...
--
ALTER TABLE `product`
  ADD CONSTRAINT `FK_FARM_ID` FOREIGN KEY (`Farm_ID`) REFERENCES `farm` (`Farm_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT;
